        ...
        >
          ...
          >
            ...
            <Box mt={{ base: "1rem", lg: "none" }}>
              <YouTube videoId="vXKotssNyIA" opts={opts} />
            </Box>
          </Flex>
        </Flex>
      </Box>
...
<Flex my='2rem' flexDirection='column' justifyContent='left' width='50%'>

      <Heading fontSize="md" color="secondaryBlue" mb={6}>
        Benefit of Autoclub
      </Heading>
      <Text color="text" fontWeight={500} fontSize='md'>
        The VIP Auto Club is designed exclusively for you our esteemed customer
        who value convenience, reliability, and exceptional automotive service.
      </Text>
      ...
      <Box color="text">
        ...
        <Flex justifyContent="space-between" alignItems='center' mb='2rem'>
          <Flex flexDirection="column">
            <Flex flexBasis={{ base: "100%", md: "48%" }} mb={8} alignItems='center'>
              ...
              <Box>
                ...
                <Text color="text">
                  Get fast, efficient lube services to keep your vehicle running
                  smoothly.
                </Text>
              </Box>
            </Flex>
            ...
            <Flex flexBasis={{ base: "100%", md: "48%" }} mb={8} alignItems='center'>
              ...
              <Box>
                ...
                <Text color="text">
                  Team members receive timely reminders to keep your vehicle in
                  top condition.
                </Text>
              </Box>
            </Flex>
          </Flex>
          <Flex justifyContent="center" alignItems="center" mt={8} height='70%'>
...
<Box>
  <PackagesSection/>
      ...
      <Box bgColor="primaryBlue" py={16} px={20} maxW="60%" margin="0 auto">
        <Box>
